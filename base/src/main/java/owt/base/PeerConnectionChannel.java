...
//            peerConnection.setBitrate(1200*1000,2800*1000,2800*1000);
//        }
    ...
    private SessionDescription preferCodec(SessionDescription originalSdp,
        ...
        Log.d("owt-tag","originalSdp.description-->" + originalSdp.description);
...
//                if(!video && payloadType.equals("110")){
//                    putEntry(preferredPayloadTypes, "aac", payloadType);
//                    Log.d("owt-tag","codecName-->" + codecName);
//                    Log.d("owt-tag","payloadType-->" + payloadType);
//                    Log.d("owt-tag","preferredPayloadTypes-->" + preferredPayloadTypes.toString());
//                }else{
...
//            encoding.minBitrateBps = 2800*1000;
//            encoding.maxBitrateBps = 5600*1000;
        }
    ...
    public void onCreateSuccess(final SessionDescription sessionDescription) {
        ...
        pcExecutor.execute(() -> {
            ...
            Log.e("pcChannels","setLocalDescription");
